...
class Warrior(Player):
    ...
    def attack(self, target):
        ...
        """
        damage = random.randint(self.strength - 2, self.strength + 5)
        target.take_damage(damage)
        print(f"{self.name} attacks {target.name} for {damage} damage!")
...
class Mage(Player):
    ...
    def attack(self, target):
        ...
        """
        damage = random.randint(self.magic - 2, self.magic + 5)
        target.take_damage(damage)
        print(f"{self.name} attacks {target.name} for {damage} damage!")
...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        """
        regular_damage = random.randint(self.strength - 2, self.strength + 5)
        critical_hit = self.strength + 10
...
class Weapon:
    ...
    def display_info(self):
        ...
        """
        print(f"{self.name} has {self.damage_bonus} damage!")
...
if __name__ == "__main__":
    ...
    print("=" * 50)
#test characters and their displays
    ...
    mage.display_stats()
    rogue.display_stats()
#Test dummy for practice battles
...
#Weapons for characters
    ...
    sword = Weapon("Dual Daggers", 10)
    staff = Weapon("Straw Doll", 15)
    dagger = Weapon("Needle", 8)
